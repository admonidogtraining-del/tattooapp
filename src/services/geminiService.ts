...
const TATTOO_INSPIRATIONS = [
  ...
  'A crow perched on a crumbling cathedral spire, one wing spread, storm clouds behind it — wisdom that outlives empires',
  'A great white shark breaching from an ocean made of ink, jaws open mid-air — raw, untamed forward motion',
  'A lone bison standing in snow, breath visible, Milky Way arching above — ancient endurance in a cold universe',
  'A praying mantis balanced on a sword tip, wings half-open — precision and patience as a philosophy',
  'An eagle diving with talons out, its wingspan forming a perfect crescent — swift decisive action',
  'A jellyfish floating upward through a dark sea, trailing bioluminescent tentacles — grace without direction',
  'A black panther dissolving at the edges into shadow and smoke — power that exists even when unseen',
  'A moth flying straight into a burning sun, wings catching fire but still moving forward — devotion beyond reason',
  ...
  'Two hands reaching toward each other, fingertips almost touching across a void, vines growing from the gap — connection as act of will',
  'A human eye with a keyhole for a pupil, a tiny door swinging open inside — the gaze that unlocks everything',
  'A human spine rendered as a sword, hilt at the skull base, tip at the tailbone — inner strength as weapon',
  'A fist punching upward through a concrete floor, wildflowers blooming at the impact cracks — breaking through to bloom',
  ...
  'A cracked clock face with flowers growing through the fractures, hands stopped at a significant hour — the moment that changed everything',
  'A small planet held between two fingers, continents replaced by scar tissue — carrying your whole world yourself',
  'An hourglass filled with ocean instead of sand, a shipwreck suspended mid-fall inside — time as depth to be explored',
  'A key dissolving into birds at the bow end — freedom found when you stop searching for the lock',
  'A black sun rising over a desert of bones, a single green shoot pushing through the sand at the foreground — hope at the end of things',
  ...
  "A vintage diver's helmet submerged deep, a lighthouse beam shining from inside the porthole — light you carry into dark places",
  'A broken sword driven into stone, wildflowers growing from the hilt — the peace that follows a long fight',
  'A grandfather clock melting at the base, time pooling on the floor like water — what can never be recovered',
  'A gas mask with a garden growing from the filter — survival through what should be toxic',
  "An old compass rose with a wolf's head at true north — instinct as your truest guide",
  ...
  'A skull half-submerged in a tide of flowers, one empty eye socket blooming with a single daisy — death as fertile ground',
  'A figure standing at the edge of a black forest, a lantern raised, shadows retreating — courage as the act of moving anyway',
  'A broken hourglass with the sand forming a pair of wings mid-collapse — freedom found in running out of time',
  'A hand releasing a paper boat into a dark river, watching it carry a tiny flame downstream — letting go of what you love',
];
